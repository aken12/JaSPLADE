...
CUDA_VISIBLE_DEVICES=0 python ../../retrieve.py \
 ...
 --local_data --retrieval_output_path ${encode_dir}/result_${exp}/ --use_pseudo_doc \
 --top_n 1000 --rel_threshold 1 --force_emptying_dir --qrel_file /home/ace14788tj/aken12_2/data/msmarco/msmarco/qrels.dev.small.tsv